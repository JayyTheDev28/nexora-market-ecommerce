...
<div class="group flex flex-col bg-surface-container-lowest rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300">
    ...
    <div class="relative w-full aspect-square rounded-t-2xl overflow-hidden bg-surface-container">
        ...
        <button
            type="button"
            class="absolute top-4 right-4 w-10 h-10 rounded-full bg-surface-container-lowest/90 backdrop-blur flex items-center justify-center shadow-sm transition-colors {{ ($product->wishlisted ?? false) ? 'text-error' : 'text-on-surface hover:text-error' }}"
    ...
    <a href="{{ $product->url ?? '#' }}" class="p-5 flex flex-col gap-2">
        ...
        <div class="flex items-center justify-between mt-2">
            ...
            <button
                type="button"
                class="w-10 h-10 rounded-full bg-surface-container flex items-center justify-center text-on-surface hover:bg-primary hover:text-on-primary transition-colors"
