{{--
    ...
    a container sized h-[calc(100vh-5rem)].
--}}
<div class="hidden md:flex md:w-2/5 lg:w-1/3 h-full flex-shrink-0 relative overflow-hidden bg-gradient-to-br from-surface-container-low via-surface to-primary-fixed items-center justify-center">
    ...
    <div class="absolute w-[440px] h-[440px] rounded-full border border-dashed border-primary/20 nx-rotate-slow"></div>
    <div class="absolute w-[320px] h-[320px] rounded-full border border-dashed border-primary/30 nx-rotate-slow-reverse"></div>
    <div class="absolute w-[260px] h-[260px] rounded-full bg-primary/10 blur-3xl"></div>
    ...
    <div class="relative nx-float">
        <svg width="170" height="170" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" style="filter: drop-shadow(0 20px 30px rgba(0,88,190,0.35));">
            <defs>
